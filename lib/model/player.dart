...
class Player extends Actor{
  Player(var game,int id,double posX, double posY) : super(game,id,posX, posY ,56,27,6){
    classes.add("player");
  }
...
///erstellt einen schuss der in richtung fadenkreutz fliegt
  void shoot() {
    game.actors.add(Shot(game,game.currentEntityID++,posX+ sizeX/2,posY+sizeY/2,cross.posX+cross.sizeX/2,cross.posY)
      ..classes.add("friendlyFire")..damage = this.damage);
