...
class MiniMap{
  ...
  void adjust(Player thatMe, List<Enemy> enemies){
    ...
    for(Enemy e in enemies){
      temporaryImageHolder = enemyDots.firstWhere((x) => x.id == "enemyDotNr$i"); //Anhand von i bekommen wir hier das dazugehörige Element
      i++;
      temporaryImageHolder.style.left = '${((e.curr_pos_X / worldSizeX) * 100)}%';
      temporaryImageHolder.style.bottom = '${((e.curr_pos_Y / worldSizeY) * 100)}%';
    }
  }
}